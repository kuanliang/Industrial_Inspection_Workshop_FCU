...
def get_mask_seg_ellipse(path_to_img):
    ...
    mask = cv2.ellipse(mask, (coordinates[filename_index]['x'], coordinates[filename_index]['y']),
                       (coordinates[filename_index]['major_axis'], coordinates[filename_index]['minor_axis']),
